...
"""
Üst üste getirme ve tekrar üst üste getirme ve orta derece fark bulma 
"""

cap = cv2.VideoCapture("C:\\Users\\QP\\Desktop\\videos\\video8.mkv")

img1 = cv2.imread("C:\\Users\\QP\\Desktop\\fotolar\\fotoooF.png")
...
while loop:
    ...
    try:
        ...
        sonuc1  = bit_xor(mask_alma_pembe(warped2), mask_alma_pembe(roiF), roiF)
        cv2.imshow("fark 1 ", sonuc1[2]),
        sonuc2 = bit_xor(mask_alma_beyaz(warped2), mask_alma_beyaz(roiF), roiF)
        cv2.imshow("fark 2 ", sonuc2[2])
