...
def goruntu_isleme(frame):
    ...
    try:
        ...
        cv2.putText(frame, "Alan hesaplanamadi !", (10, 530), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 0), 2, cv2.LINE_AA)
        frame = videoGoster(frame)
        #cv2.waitKey(50)
        return frame
    ...
    if bigArea < 10000:
        cv2.putText(frame, "Alan kucuk !", (10, 530), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 0), 2, cv2.LINE_AA)
        #print("Alan küçük")
        frame = videoGoster(frame)
        #cv2.waitKey(50)
        return frame
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if len(pending_task) < thread_num:
            ...
            if ret:
                ...
                task = pool.apply_async(goruntu_isleme, (frame.copy(),))
    ...
    print("Video su kadar surede oynatildi : ", int(end-start), " sn")
    print("Video ", counter, " kes fps dropu yedi")
