...
"""
                     --- Coral Reef Main Code Gstreamer dan Görüntü Çekme Deneme ---
    Thread kullanımı yok. Düz sırayla işlemler yapılıyor. Tüm değişkenlere ve fonksiyonlara İngilizce isimler yazıldı.
Saniyede ortalama 7 - 8 frame işlenmektedir. Ubuntu işletim sistemi kullanılması şarttır gstreamer kodları yüzünden. 
Coral.get_image fonksiyonun gstreamerdan alınan frameler verilir.
