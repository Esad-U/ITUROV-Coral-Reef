...
sortedPointsX = sorted(pointsX)
index = pointsX.index(sortedPointsX[-1])
pts = points[index]

alt.append(pts)
olmasiGerekenAlt.append(pts)

print(alt)
print(olmasiGerekenAlt)

keypoints1 = np.float32(alt)
keypoints2 = np.float32(olmasiGerekenAlt)
