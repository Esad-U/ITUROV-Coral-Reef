...
"""
Üst üste getirme ve tekrar üst üste getirme ve basit fark bulma 
"""

cap = cv2.VideoCapture("C:\\Users\\QP\\Desktop\\videos\\video8.mkv")

img1 = cv2.imread("C:\\Users\\QP\\Desktop\\fotolar\\fotooo.png")
...
while loop:
    ...
    try:
        ...
        sonuc = bit_xor(mask_alma(warped), mask_alma(roiF), warped)
        cv2.imshow("Added", added)
        # cv2.imshow("xor", sonuc[1])
        cv2.imshow("fark 1 ", sonuc[2])
        sonuc2  = bit_xor(mask_alma(warped2), mask_alma(roiF), roiF)
